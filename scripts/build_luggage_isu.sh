...
drush $ALIAS si minimal -y --db-url=mysql://$DBCREDS@localhost/luggage_isu_TEST --site-name=luggage_isu_TEST --account-name=adminn install_configure_form.update_status_module='array(FALSE,FALSE)'
